...
export const Body = () => {
    return (
        <div className='top-0 flex justify-center items-center  h-screen overflow-x-auto'>
            <div className=' pb-24 relative flex-col top-0 flex justify-center items-start  md:h-96  md:pl-16 pl-9'>
                ...
                <h1 className='md:text-5xl italic font-medium p-2 text-1xl  py-0  text-white'>Under Maintenance</h1>
            </div>
