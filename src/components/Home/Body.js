        ...
        <div className='h-full overflow-hidden fancy-scrollbar'>
            ...
            >
                <div className='mb-24' style={{ textAlign: 'center', color: 'white' }}>
                    ...
                    <h1 className='text-6xl md:text-[9rem] animate__animated animate__hinge ' style={{ fontFamily: "Amsterdam-2" }}  >Kaushal Raj</h1>
                </div>
            </motion.div>
            {showNormalContent && (
                <div className='flex flex-col justify-center items-center h-full fancy-scrollbar'>
                    ...
                    <section className='w-full h-[30rem] bg-white flex justify-center items-center '>
                        <section className='w-3/5 h-4/5 bg-gray-100 flex justify-between flex-col rounded-md'>
                            ...
                            <section className='h-3/4 translate-y-8 rounded-t-2xl rounded-b-lg bg-gradient-to-br from-blue-400 to-cyan-400 transition-transform duration-300 group-hover:translate-y-3 group-hover:rotate-[1deg] md:mx-24 flex flex-col justify-start items-center'>
                    ...
                    <section className='w-full h-[15rem] bg-black flex items-center justify-center'>
                        <div className='bg-white rounded my-25 p-4 relative  mt-2  w-3/4'>
                            <p className=' text-center text-black  text-lg md:text-md lg:text-xl xl:text-2xl'>It's <span className='bg-black text-white px-1 md:px-3 label-tag-sm label-tag  rounded'> {time}</span> {message} <span className='bg-black text-white px-1 md:px:3 label-tag-sm label-tag  rounded'> Happy {dayOfWeek} </span></p>
                        </div>
