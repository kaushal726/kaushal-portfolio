...
let Readme = () => {
    return (
        <div className="relative grid md:grid-cols-3 rounded-3xl z-40 background  h-full m-5">
            <div className="flex items-center justify-center">
                <img className="p-4 rounded-full md:w-3/4 w-1/2" src={readmeImg} alt=""></img>
            </div>
            <div className="h-full flex justify-center items-center flex-col md:col-span-2 md:p-10 p-3">
